...
public class SQLServices extends SQLiteOpenHelper {
    ...
    private void insertTestData(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO `Answer` VALUES (1,1,0,'Tombé dans la neige avant de 31 décembre',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,1,1,'Un frizby comestible',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,1,2,'Une kipa surgelée',1);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,1,3,'D la réponse D',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,2,0,'Qu''il n''est pas arrivé à Toronto',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,2,1,'Qu''il était supposé arriver à Toronto...',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,2,2,'Qu''est ce qu''il faut ce maudit pancake, tabernacle',1);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,2,3,'D la réponse D',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,3,0,'L''inciter à boire à l''Open Barmitzva',1);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,3,1,'Lui présenter raymond Barmitzva',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,3,2,'Lui offrir des Malabarmitzva',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,3,3,'D la réponse D',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,4,0,'En 1618, pendant la guerre des croissants au beurre',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,4,1,'En 1702, pendant le massacre du Saint Panini',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,4,2,'En 112, avant Céline Dion pendant la guerre de la brioche',1);");
        db.execSQL("INSERT INTO `Answer` VALUES (1,4,3,'D la réponse D',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,1,0,'Methodologie de la production d''application',1);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,1,1,'Analyse',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,1,2,'UML',1);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,1,3,'Android',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,1,4,'Java',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,1,6,'PHP',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,2,0,'Mateo Rat',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,2,1,'Lucas Secret',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,2,2,'Balthazar Frolin',1);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,2,3,'Martin Braun',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,3,0,'Oh Juste un doigt',1);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,3,1,'Avez plaisir',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,3,2,'Non merci',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,3,3,'Je préfère des gencives de porc',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,4,0,'Je vous ai demandé des gencives de porc',1);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,4,1,'Sais tu danser les Cariocca ?',1);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,4,2,'Prenez un chewing gum emil',1);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,5,0,'mange des gencives de porc',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,5,1,'vomis',1);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,5,2,'suis content',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,5,3,'tousse',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,5,4,'saute',0);");
        db.execSQL("INSERT INTO `Answer` VALUES (2,5,5,'souris',0);");
    }
}
