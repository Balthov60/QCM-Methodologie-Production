...
public class QuestionTeacherListAdapter extends ArrayAdapter<Question> {
    ...
    public QuestionTeacherListAdapter(Context context, int idMCQ, List<Question> questionsList,
